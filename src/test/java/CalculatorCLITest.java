...
public class CalculatorCLITest {
    private final CalculatorCLI calculator = new CalculatorCLI();
    ...
    void testValidNumberInput() {
        ...
        try {
            double result = calculator.handleNumberInput(scanner);
    ...
    void testClearInNumberInput2() {
        ...
        try {
            calculator.processCalculations(scanner, 1);
    ...
    void testValidOperatorInput() {
        ...
        for (char operator : validOperators) {
            ...
            char result = calculator.handleOperatorInput(scanner);
    ...
    void testMultipleCalculations() {
        ...
        try {
            calculator.processCalculations(scanner, 2);
    ...
    void testExitDuringNumberInput() {
        ...
        try {
            calculator.handleNumberInput(new Scanner(System.in));
            fail("ExitException was not thrown.");
        } catch (CalculatorCLI.ExitException e) {
    ...
    void testExitDuringOperatorInput() {
        ...
        try {
            calculator.handleOperatorInput(new Scanner(System.in));
            fail("ExitException was not thrown.");
        } catch (CalculatorCLI.ExitException e) {
            assertEquals("User chose to exit the program.", e.getMessage());
        }
